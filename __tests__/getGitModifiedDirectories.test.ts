...
test('get modified directories', async () => {
    ...
    await expect(getGitModifiedDirectories('.', '86e35d7e707289588dcf6f825be3e7c3e854cf58', '009ec5a0e9196b668d926916eaeb6f778694074f', ['root_path'], new Log))
        .resolves.toEqual(['__tests__', '__tests__/tf_project/000-first', '__tests__/tf_project/010-second', 'src'])
})
